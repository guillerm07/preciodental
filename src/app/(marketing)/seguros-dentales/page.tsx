    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-2">
        {INSURANCES.map((ins) => (
          ...
          >
            <div className={`h-full rounded-xl border ${ins.color} p-5 transition-all hover:shadow-md`}>
              <div className="flex items-start justify-between">
                <h2 className="text-lg font-bold text-gray-900 group-hover:text-primary-600 transition-colors">
                  {ins.name}
                </h2>
                <span className="shrink-0 rounded-full bg-white px-2.5 py-0.5 text-xs font-medium text-gray-600 shadow-sm">
                  {ins.clinics} clínicas
                </span>
              </div>
              <p className="mt-2 text-sm text-gray-600">{ins.description}</p>
              <p className="mt-3 text-sm font-semibold text-primary-600 group-hover:translate-x-0.5 transition-transform">
                Ver baremo completo →
              </p>
            </div>
          </Link>
      ...
      <section className="mt-12">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          <div className="rounded-xl border-2 border-accent-200 bg-accent-50 p-5">
            <div className="flex items-center gap-2">
              <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-accent-600 text-sm font-bold text-white">
                A
              </span>
              <h3 className="font-bold text-gray-900">Zona A — Precios más bajos</h3>
            </div>
          ...
          <div className="rounded-xl border-2 border-gray-200 bg-gray-50 p-5">
            <div className="flex items-center gap-2">
              <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-gray-600 text-sm font-bold text-white">
                B
              </span>
              <h3 className="font-bold text-gray-900">Zona B — Precios superiores</h3>
            </div>
            <ul className="mt-3 space-y-1">
